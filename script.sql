...
CREATE TABLE IF NOT EXISTS `herois`.`personagem` (
  ...
  INDEX `fk_personagem_tipo1_idx` (`id_tipo` ASC),
  CONSTRAINT `fk_personagem_tipo1`
    FOREIGN KEY (`id_tipo`)
...
CREATE TABLE IF NOT EXISTS `herois`.`especialidade_personagem` (
  `id_especialidade` INT(11) NOT NULL,
  `id_personagem` INT(11) NOT NULL,
  PRIMARY KEY (`id_especialidade`, `id_personagem`),
  INDEX `fk_especialidade_has_personagem_personagem1_idx` (`id_personagem` ASC),
  INDEX `fk_especialidade_has_personagem_especialidade1_idx` (`id_especialidade` ASC),
  CONSTRAINT `fk_especialidade_has_personagem_especialidade1`
    FOREIGN KEY (`id_especialidade`)
    REFERENCES `herois`.`especialidade` (`id_especialidade`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_especialidade_has_personagem_personagem1`
    FOREIGN KEY (`id_personagem`)
    REFERENCES `herois`.`personagem` (`id_personagem`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
